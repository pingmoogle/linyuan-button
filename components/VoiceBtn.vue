...
.vo-btn-bg-light {
  background: linear-gradient(to right, #a00035 var(--start-percent), #a00035 var(--progress));
}

.vo-btn-bg-dark {
  background: linear-gradient(to right, #55001c var(--start-percent), #55001c var(--progress));
}
